                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {{-- @dd($reservasi->dpaket->fpaket_wisata->id); --}}
                            <input type="hidden" name="id_daftar_paket" id="id_daftar_paket" value="{{$reservasi->dpaket->fpaket_wisata->id ?? old('id_daftar_paket')}}">
                            <input type="text" class="form-control @error('nama_paket') is-invalid @enderror" placeholder="Cari Nama Paket" 
                                id="nama_paket" name="nama_paket" value="{{$reservasi->dpaket->fpaket_wisata->nama_paket ?? old('nama_paket')}}" aria-describedby="cari" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('tgl_reservasi_wisata') is-invalid @enderror" 
                            id="tgl_reservasi_wisata" name="tgl_reservasi_wisata" value="{{ old('tgl_reservasi_wisata') ? \Carbon\Carbon::parse(old('tgl_reservasi_wisata'))->format('Y-m-d') : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number " class="form-control @error('jumlah_peserta') is-invalid @enderror" 
                            id="jumlah_peserta"  name="jumlah_peserta" value="{{$reservasi->jumlah_peserta ?? old('jumlah_peserta')}}" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('harga_paket') is-invalid @enderror" 
                            id="harga_paket" name="harga_paket" value="{{$reservasi->harga_paket ?? old('harga_paket')}}" readonly>
                    ...
                    <div class="form-group">
                        <label for="diskon">Diskon</label>
                            ...
                            id="diskon" name="diskon" value="{{$reservasi->diskon * 100 ?? old('diskon')}}%"readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nilai_diskon') is-invalid @enderror" 
                            id="nilai_diskon"  name="nilai_diskon" value="{{$reservasi->nilai_diskon ?? old('nilai_diskon')}}" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('total_bayar') is-invalid @enderror" 
                            id="total_bayar"  name="total_bayar" value="{{$reservasi->total_bayar ?? old('total_bayar')}}">
                    ...
                    <div class="form-group">
                        ...
                        <img class="img-preview img-fluid mb-3 col-sm-5 d-block"  src="{{ asset('/storage/Bukti Transfer/' . $reservasi->file_bukti_tf) }}"
