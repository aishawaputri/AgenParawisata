...
<h1 class="font-weight-bold">Tambah Paket Wisata</h1>
@stop
@section('content')
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_paket') is-invalid @enderror"
                            id="nama_paket" placeholder="Nama Paket" name="nama_paket" value="{{old('nama_paket')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('diskon') is-invalid @enderror" id="diskon"
                            placeholder="Diskon Paket Wisata" name="diskon" value="{{old('diskon')}}">
